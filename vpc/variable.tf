...
variable "control_plane_sg_description" {
  description = "Description of the security group for the EKS control plane"
  type        = string
  default     = "EKS control plane security group"
}
...
variable "worker_nodes_sg_description" {
  description = "Description of the security group for EKS worker nodes"
  type        = string
  default     = "EKS worker nodes security group"
}
